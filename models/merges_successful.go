...
type MergesSuccessful struct {
	...
	// parents
	Parents MergesSuccessfulParents `json:"parents"`
...
func (m *MergesSuccessful) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MergesSuccessful) UnmarshalBinary(b []byte) error {
	var res MergesSuccessful
