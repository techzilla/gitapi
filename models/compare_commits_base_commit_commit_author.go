...
func (m *CompareCommitsBaseCommitCommitAuthor) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CompareCommitsBaseCommitCommitAuthor) UnmarshalBinary(b []byte) error {
	var res CompareCommitsBaseCommitCommitAuthor
