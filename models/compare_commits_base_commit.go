...
type CompareCommitsBaseCommit struct {
	...
	// parents
	Parents CompareCommitsBaseCommitParents `json:"parents"`
...
func (m *CompareCommitsBaseCommit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CompareCommitsBaseCommit) UnmarshalBinary(b []byte) error {
	var res CompareCommitsBaseCommit
