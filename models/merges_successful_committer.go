...
func (m *MergesSuccessfulCommitter) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MergesSuccessfulCommitter) UnmarshalBinary(b []byte) error {
	var res MergesSuccessfulCommitter
