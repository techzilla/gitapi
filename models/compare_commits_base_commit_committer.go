...
func (m *CompareCommitsBaseCommitCommitter) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CompareCommitsBaseCommitCommitter) UnmarshalBinary(b []byte) error {
	var res CompareCommitsBaseCommitCommitter
