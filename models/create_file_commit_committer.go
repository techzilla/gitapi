...
func (m *CreateFileCommitCommitter) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateFileCommitCommitter) UnmarshalBinary(b []byte) error {
	var res CreateFileCommitCommitter
