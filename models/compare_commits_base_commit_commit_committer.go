...
func (m *CompareCommitsBaseCommitCommitCommitter) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CompareCommitsBaseCommitCommitCommitter) UnmarshalBinary(b []byte) error {
	var res CompareCommitsBaseCommitCommitCommitter
