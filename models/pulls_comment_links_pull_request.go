...
func (m *PullsCommentLinksPullRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PullsCommentLinksPullRequest) UnmarshalBinary(b []byte) error {
	var res PullsCommentLinksPullRequest
