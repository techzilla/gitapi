...
func (m *CompareCommitsBaseCommitAuthor) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CompareCommitsBaseCommitAuthor) UnmarshalBinary(b []byte) error {
	var res CompareCommitsBaseCommitAuthor
