...
func (m *FeedsLinksCurrentUserOrganization) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FeedsLinksCurrentUserOrganization) UnmarshalBinary(b []byte) error {
	var res FeedsLinksCurrentUserOrganization
