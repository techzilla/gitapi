...
func (m *FeedsLinksCurrentUserActor) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FeedsLinksCurrentUserActor) UnmarshalBinary(b []byte) error {
	var res FeedsLinksCurrentUserActor
