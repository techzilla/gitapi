...
// NewGetOrgsOrgIssuesParams creates a new GetOrgsOrgIssuesParams object
// with the default values initialized.
func NewGetOrgsOrgIssuesParams() GetOrgsOrgIssuesParams {
	var (
...
// GetOrgsOrgIssuesParams contains all the bound params for the get orgs org issues operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetOrgsOrgIssues
type GetOrgsOrgIssuesParams struct {
...
func (o *GetOrgsOrgIssuesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetOrgsOrgIssuesParams) bindAccept(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetOrgsOrgIssuesParams) bindXGitHubMediaType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOrgsOrgIssuesParams) bindXGitHubRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOrgsOrgIssuesParams) bindXRateLimitLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOrgsOrgIssuesParams) bindXRateLimitRemaining(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOrgsOrgIssuesParams) bindXRateLimitReset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOrgsOrgIssuesParams) bindDirection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetOrgsOrgIssuesParams) validateDirection(formats strfmt.Registry) error {
...
func (o *GetOrgsOrgIssuesParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetOrgsOrgIssuesParams) validateFilter(formats strfmt.Registry) error {
...
func (o *GetOrgsOrgIssuesParams) bindLabels(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetOrgsOrgIssuesParams) bindOrg(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOrgsOrgIssuesParams) bindSince(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetOrgsOrgIssuesParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetOrgsOrgIssuesParams) validateSort(formats strfmt.Registry) error {
...
func (o *GetOrgsOrgIssuesParams) bindState(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetOrgsOrgIssuesParams) validateState(formats strfmt.Registry) error {
